...
# agent_1_events = ['door_1', 'red', 'target_1']
...
agent_1_events_trust = ['door_1', 'trust', 'blue', 'target_1']
agent_2_events_trust = ['door_2', 'trust', 'red', 'door_3', 'blue']
...
def create_first_individual_rm():
    ...
    automaton.set_accepting_state(state_4, True)
    ...
    automaton.add_transition((state_2, 'blue', state_3))
    automaton.add_transition((state_2, 'red', state_2))

    automaton.add_transition((state_3, 'blue', state_3))
    automaton.add_transition((state_3, 'target_1', state_4))
