...
class Training:
    ...
    def update_agents_states(
        ...
        for agent_idx in range(self.n_agents):
            env.agents[agent_idx].update_state(env.get_event())
    ...
    def dont_skip_random_train(
        ...
        agent_state = copy.copy(env.agents[agent_idx].get_state())
        agent_task_selected = copy.copy(env.agents[agent_idx].get_selected_task_id())
